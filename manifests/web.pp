class rgbank::web (
  ...
  $db_user,
  $db_password,
  $version = lookup('rgbank-build-version', default => 'master'),
  $source = lookup('rgbank-build-path', default => 'http://cdpe-carl-docker.delivery.puppetlabs.net/ccaum/rgbank'),
  $source_type = lookup('rgbank-build-source-type', default => 'vcs'),
